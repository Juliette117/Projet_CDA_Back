...
import { Music } from '@wpl/shared/entities/music.entity';
import { Playlist } from '@wpl/shared/entities/playlist.entity';
...
describe('PlaylistsService', () => {
  ...
  it('should create a playlist', async () => {
    const createSpy = jest
      ...
      .mockReturnValue({ name: 'Playlist 1' } as any);
    const saveSpy = jest
      .spyOn(playlistRepository, 'save')
      .mockResolvedValue({ id: 1, name: 'Playlist 1' } as any);
